			...
			<div class="row">
				<div class="col-12">
					<div class="bread-content">
						<h1 class="breadcumb-title text-white">Contact</h1>
	...
	<!-- ================================== Start Contact Page Area Section ================================================ -->
	<section class="contact-area-page section-padding">
		<div class="container">
			<div class="row">
				<div class="col-xl-4 col-lg-6 col-md-6">
					<div class="contact-item">
						...
						<div class="contact-item-content">
							<p class="contact-us"><i class="fas fa-angle-double-right"></i> CALL US 24/6</p>
							<h6>
								<a href="tel:+91<?php echo $profile->number; ?>" class="contact-link">
									+91 <?php echo $profile->number; ?>
								</a>
							</h6>
						</div>
					</div>
				...
				<div class="col-xl-4 col-lg-6 col-md-6">
					<div class="contact-item">
						...
						<div class="contact-item-content">
							<p class="contact-us"><i class="fas fa-angle-double-right"></i> MAKE A QUOTE</p>
							<h6>
								<a href="mailto:<?php echo $profile->email; ?>" class="contact-link">
				...
				<div class="col-xl-4 col-lg-6 col-md-6">
					<div class="contact-item">
						...
						<div class="contact-item-content">
							<p class="contact-us"><i class="fas fa-angle-double-right"></i> HEAD OFFICE</p>
			...
			<div class="row contact-margin-top">
				<div class="col-lg-6 col-md-12">
					<div class="appoinment-form-wrap team-title">
						<h6 class="sub-title"><span class="dash"></span>Get In Touch</h6>
						<h2 class="title">Let’s discuss about your project.</h2>
						
						<form id="contact" action="<?= base_url('form/contact') ?>" method="post">
							<div class="row">

								<div class="col-md-6 mb-3">
									<input type="text" class="form-control style" placeholder="Organisation Name"
										name="name" minlength="3" required>
								</div>

								<div class="col-md-6 mb-3">
									<input type="text" class="form-control style" placeholder="Owner Name" name="onname"
										minlength="3" required>
								</div>

								<div class="col-md-6 mb-3">
									<input type="tel" class="form-control style" placeholder="Contact Number" name="mobile"
										pattern="[6-9]{1}[0-9]{9}" title="Enter valid 10 digit mobile number" required>
								</div>

								<div class="col-md-6 mb-3">
									<input type="email" class="form-control style" placeholder="Email" name="email"
										required>
								</div>

								<div class="col-md-6 mb-3">
									<input type="text" class="form-control style" placeholder="Location" minlength="2"
										name="location" required>
								</div>

								<div class="col-md-6 mb-3">
									<input type="text" class="form-control style" placeholder="Subject" minlength="3"
										name="subject" required>
								</div>

								<div class="col-12 mb-4">
									<textarea rows="5" class="form-control style" placeholder="Message" minlength="10"
				...
				<div class="col-lg-6 col-md-12">
					<div class="contact-maps">
						<iframe
							src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2480.3433789187993!2d73.02541651869234!3d19.091380628515804!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c11b38ee652b%3A0xed090eab7f937769!2sGami%20Industrial%20Park%2C%20MIDC%20Industrial%20Area%2C%20Pawne%2C%20Navi%20Mumbai%2C%20Maharashtra%20400703!5e0!3m2!1sen!2sin!4v1763114866869!5m2!1sen!2sin"
