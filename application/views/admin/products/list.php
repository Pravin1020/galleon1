	...
	<div class="content content-two">
		...
		<div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
			...
			<div class="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
				<div>
					<a href="<?php echo base_url()?>admin/productadd" class="btn btn-primary d-flex align-items-center">
						<i class="isax isax-add-circle5 me-1"></i>Add Product
					</a>
				</div>
			</div>
		</div>
			...
			<table class="table table-nowrap datatable">
				<thead class="thead-light">
					<tr>
						...
						<th class="no-sort">Product Title</th>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<?php 
     					   $ptitle = $p['ptitle'];
     					   echo (strlen($ptitle) > 25) ? substr($ptitle, 0, 25) . '...' : $ptitle;
    						?>
						</td>
						<td>
							<?php 
     					   $cname = $p['category'];
     					   echo (strlen($cname) > 25) ? substr($cname, 0, 25) . '...' : $cname;
    						?>
						</td>
						<td>
							<img src="<?php echo base_url('uploads/product/'.$p['pimage']); ?>" alt="Product Image"
						...
						<td class="action-item">
							...
							<ul class="dropdown-menu">
								<li>
									<a href="<?php echo base_url();?>admin/productadd/<?php echo $p['id'];?>"
										class="dropdown-item d-flex align-items-center"><i
											class="isax isax-edit me-2"></i>Edit</a>
								</li>
								<li>
									<a href="<?php echo base_url();?>forms/removeproduct/<?php echo $p['id'];?>"
										class="dropdown-item d-flex align-items-center"><i
